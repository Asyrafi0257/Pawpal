...
(user_id, pet_name, pet_type, category, description, gender, age, health, image_path, lat, lng, created_at) 
VALUES 
('$userid','$petName','$petType','$category','$description','$gender','$age','$health','', '$latitude','$longitude','$createdAt')";
